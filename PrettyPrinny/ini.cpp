...
{
  pp::INI::File::Section section (name);
...
bool
Import_Section (pp::INI::File::Section& section, wchar_t* buffer, int start, int end)
{
  int key = start;
  for (int k = key; k < end; k++) {
    if (k < end - 1 && buffer [k] == L'=') {
...
void
pp::INI::File::import (std::wstring import_data)
{
...
std::wstring&
pp::INI::File::Section::get_value (std::wstring key)
{
...
bool
pp::INI::File::Section::contains_key (std::wstring key)
{
...
void
pp::INI::File::Section::add_key_value (std::wstring key, std::wstring value)
{
...
bool
pp::INI::File::contains_section (std::wstring section)
{
  return sections.find (section) != sections.end ();
}

pp::INI::File::Section&
pp::INI::File::get_section (std::wstring section)
{
...
const std::map <std::wstring, pp::INI::File::Section>&
pp::INI::File::get_sections (void)
{
  return sections;
}