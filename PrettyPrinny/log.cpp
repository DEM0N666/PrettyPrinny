...
WORD
PP_Timestamp (wchar_t* const out)
{
...
bool
pp_logger_s::init (const char* const szFileName,
...
void
pp_logger_s::LogEx (bool                 _Timestamp,
                     ...
                     wchar_t const* const _Format, ...)
{
  ...
  if (_Timestamp) {
    ...
    WORD ms = PP_Timestamp (wszLogTime);
...
void
pp_logger_s::Log   (_In_z_ _Printf_format_string_
                    wchar_t const* const _Format, ...)
{
  va_list _ArgList;
